...
public class StudentTest01 {
    ...
    public void selectAll() throws Exception{
        ...
        SqlSession sqlSession = sqlSessionFactory.openSession();
        System.out.println(sqlSessionFactory.getConfiguration().getMappedStatementNames());
        //4.执行映射配置文件中的sql语句，并接收结果
        List<Student> list = sqlSession.selectList("com.itheima.mapper.StudentMapper.selectAll");
